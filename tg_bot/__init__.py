...
if sys.version_info[0] < 3 or sys.version_info[1] < 6:
    LOGGER.error("You MUST have a python version of at least 3.6!!Varna niklll.")
    quit(1)
...
if ENV:
    ...
    BAN_STICKER = os.environ.get('BAN_STICKER', 'CAACAgUAAxkBAAEEhBBesBJbXxSbSM-b67YjFyQX5L0_lwACTwADslkNK2oaBPGvL1cXGQQ')
